...
<div class="container" id="page">
	...
	<div id="header">
            <div id="logo"><?= Yii::t('global', 'Title') ?></div>
	</div><!-- header -->
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>Yii::t('global', 'Technologies'), 'url'=>array('/technologies/index')),
				...
				array('label'=>Yii::t('global', 'Logout') . '  ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
                                ...
                                array('label'=>'Español', 'url'=>array('/es'), ),
                                array('label'=>'English', 'url'=>array('/en'), ),
			),
		)); ?>
	</div><!-- mainmenu -->
	...
	<div id="footer">
		Copyleft &copy; <?php echo date('Y'); ?> by Margori.<br/>
		All Wrongs Reserved.<br/>
		<?= Yii::powered() . _(' and love.') ?> 
	</div><!-- footer -->
